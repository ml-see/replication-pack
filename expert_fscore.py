...
def get_expert_actual_cost():
    dataset = "./datasets/jos.sqlite3"
    try:
        conn = sqlite3.connect(dataset)
    except sqlite3.Error as e:
        print('Can not connect to JOSSE Dataset. The Error is: %s' % (e))
        return None
